...
- **DSH Web plugin**: the package root and `./client` export use the official `dsh.client` lazy-CJS contract. One installation provides the MTM Harness sidebar action and the MTM Connect control panel.
