...
describe("MtmHarnessLauncher", () => {
  it("opens a fixed-origin sandboxed iframe without credential-bearing URL state", () => {
    ...
    expect(MTM_HARNESS_LAUNCHER_READY).toBe(false);
    expect((container.querySelector('button[aria-label="MTM Cloud is not deployed"]') as HTMLButtonElement).disabled).toBe(true);
