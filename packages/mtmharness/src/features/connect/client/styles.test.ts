...
describe("mtm-connect stylesheet", () => {
  it("uses DSH semantic tokens without global theme ownership", () => {
    ...
    expect(MTM_CONNECT_CSS).toContain("@container (min-width: 620px)");
    expect(MTM_CONNECT_CSS).toContain(".mtm-modal");
    expect(MTM_CONNECT_CSS).toContain(".mtmc-summary-line");
    ...
    expect(MTM_CONNECT_CSS).toContain("[data-mtm-connect] .mtmc-summary-line");
    expect(MTM_CONNECT_CSS).toContain("max-height: calc(100vh - 32px)");
